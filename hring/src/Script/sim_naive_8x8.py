...
out_dir = "../preliminary/naive/uc/mc_0.01/"
mc_rate = 0.01
multicast = "true"
synth_rate = 0
...
out_dir = "../preliminary/naive/uc/mc_0.02/"
mc_rate = 0.02
multicast = "true"
synth_rate = 0
if not os.path.exists(out_dir):
...
synth_rate = 0
mc_rate = 0.05
out_dir = "../preliminary/naive/uc/mc_0.05/"
multicast = "true"
if not os.path.exists(out_dir):
  os.makedirs(out_dir)
...
synth_rate = 0
mc_rate = 0.1
out_dir = "../preliminary/naive/uc/mc_0.1/"
multicast = "true"
if not os.path.exists(out_dir):
  os.makedirs(out_dir)
...
out_dir = "../preliminary/naive/mc/uc_0.1/"
mc_degree = "16"
multicast = "true"
synth_rate = 0.1
mc_rate = 0
...
out_dir = "../preliminary/naive/mc/uc_0.2/"
synth_rate = 0.2
mc_rate = 0
if not os.path.exists(out_dir):
  os.makedirs(out_dir)
...
out_dir = "../preliminary/naive/mc/uc_0.3/"
synth_rate = 0.3
mc_rate = 0
if not os.path.exists(out_dir):
  os.makedirs(out_dir)
...
out_dir = "../preliminary/naive/mc/uc_0.4/"
synth_rate = 0.4
mc_rate = 0
if not os.path.exists(out_dir):
  os.makedirs(out_dir)

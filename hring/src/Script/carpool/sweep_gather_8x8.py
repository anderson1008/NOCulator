...
out_dir = "./preliminary/synthSweep/uc/no_merge/hs_0.2/"
synth_rate = 0
hs_rate = 0.2
if not os.path.exists(out_dir):
  os.makedirs(out_dir)
...
out_dir = "./preliminary/synthSweep/uc/no_merge/hs_0.3/"
synth_rate = 0
hs_rate = 0.3
if not os.path.exists(out_dir):
  os.makedirs(out_dir)
...
out_dir = "./preliminary/synthSweep/uc/no_merge/hs_0.4/"
synth_rate = 0
hs_rate = 0.4
if not os.path.exists(out_dir):
  os.makedirs(out_dir)
...
out_dir = "./preliminary/synthSweep/uc/no_merge/hs_0.5/"
synth_rate = 0
hs_rate = 0.5
if not os.path.exists(out_dir):
  os.makedirs(out_dir)
...
out_dir = "./preliminary/synthSweep/hs/no_merge/uc_0.1/"
synth_rate = 0.1
hs_rate = 0
if not os.path.exists(out_dir):
  os.makedirs(out_dir)
...
out_dir = "./preliminary/synthSweep/hs/no_merge/uc_0.2/"
synth_rate = 0.2
hs_rate = 0
if not os.path.exists(out_dir):
  os.makedirs(out_dir)
...
out_dir = "./preliminary/synthSweep/hs/no_merge/uc_0.3/"
synth_rate = 0.3
hs_rate = 0
if not os.path.exists(out_dir):
  os.makedirs(out_dir)
...
out_dir = "./preliminary/synthSweep/hs/no_merge/uc_0.4/"
synth_rate = 0.4
hs_rate = 0
if not os.path.exists(out_dir):
  os.makedirs(out_dir)
...
out_dir = "./preliminary/synthSweep/hs/no_merge/uc_0.5/"
synth_rate = 0.5
hs_rate = 0
if not os.path.exists(out_dir):
  os.makedirs(out_dir)

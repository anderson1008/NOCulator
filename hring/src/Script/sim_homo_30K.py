...
out_dir_design = "./results/homo/4x4/design/epoch30K/"
...
for sim_index in range(1, 11, 1):
  ...
  command_line = "mono ./sim.exe -config ./config_qos.txt -output " + out_dir_design + out_file + " -workload " + workload_dir + workload + ' ' + str(sim_index)+ " -throttle_enable true  -slowdown_epoch 30000 -thrt_up_slow_app 1 -thrt_down_stc_app 1"
  os.system (command_line)
